      ...
      <div className="relative about-background-gradient pb-20">
        ...
        <div className="relative cont text-white">
          ...
          <motion.h1
            ...
            className="font-nuehassMedium text-7xl md:text-8xl md:w-4/5 font-extrabold tracking-tight pt-8 mt-4 md:pt-12 mb-4 leading-tight"
          >
          ...
          <div className="xl:flex py-8 xl:space-x-7">
            <motion.div
              ...
              className="xl:w-8/12"
            >
              <p className="font-montserrat text-2xl md:text-2xl lg:text-2xl text-gray-300 leading-relaxed mb-4 md:mt-5">
              ...
              <p className="font-montserrat text-2xl md:text-2xl lg:text-2xl text-gray-300 leading-relaxed mb-4 ">
              ...
              <p className="font-montserrat text-2xl md:text-2xl lg:text-2xl text-gray-300 leading-relaxed mb-16 ">
          ...
          <section>
            <DualWeightText
              ...
              clases="!text-5xl md:!text-6xl lg:!text-7xl"
            />
            ...
            <motion.p
              ...
              variants={fadeInLeft}
              transition={{ duration: 0.8, delay: 0.5 }}
              className="md:w-3/5 py-6 font-montserrat text-2xl md:text-2xl lg:text-2xl text-gray-300 leading-relaxed"
            >
          ...
          <section className="additional-content py-8">
            ...
            <motion.ul
              ...
              variants={fadeInUp}
              transition={{ duration: 0.8, delay: 0.5 }}
              className="list-disc ml-6 text-2xl md:text-2xl lg:text-2xl py-6 md:w-3/5 text-gray-200 leading-relaxed"
            >
              <li className="mb-2">
          ...
          <section className="mission-statement">
            ...
            <motion.p
              ...
              variants={fadeInUp}
              transition={{ duration: 0.8, delay: 0.5 }}
              className="font-montserrat text-2xl md:text-2xl lg:text-2xl py-8 md:w-3/5 text-gray-300 leading-relaxed"
            >
          ...
          <section className="customer-testimonials">
            ...
            <motion.div
              ...
              className="md:w-3/5"
            >
              <blockquote className="italic text-2xl md:text-2xl lg:text-2xl pt-8 text-gray-200">
              ...
              <blockquote className="italic mt-4 text-2xl md:text-2xl lg:text-2xl text-gray-200">
